...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-thd1%%l%%!p$!^f69*yuj=t)l0wt*6_q_8(+g1qa&fblb@@qsi",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "wagtailblog")
os.environ.setdefault("DB_USER", "wagtailblog")
os.environ.setdefault("DB_PASSWORD", "wagtailblog")
