...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "wagtailblog"),
        "USER": config("DB_USER", "wagtailblog"),
        "PASSWORD": config("DB_PASSWORD", "wagtailblog"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "wagtailblog.utils.context_processors.settings",
            ],
...
DEFAULT_FROM_EMAIL = "wagtailblog@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "wagtailblog.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "wagtailblog.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "wagtailblog_sessionid"
...
CSRF_FAILURE_VIEW = "wagtailblog.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "wagtailblog.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"wagtailblog {ENVIRONMENT}",
