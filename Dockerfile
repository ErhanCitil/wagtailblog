...
COPY --from=frontend-build /app/src/wagtailblog/static /app/src/wagtailblog/static
...
ENV RELEASE=${RELEASE} \
    GIT_SHA=${COMMIT_HASH} \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=wagtailblog.conf.docker

ARG SECRET_KEY=dummy

LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://bitbucket.org/maykinmedia/wagtailblog" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="wagtailblog"
